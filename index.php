        ...
        <div class="row js--wp-1">
            <div class="col span-1-of-4 box">
             ...
             <div class="col span-1-of-4 box">
                ...
                <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with the best chefs in each town t</p>
            </div>
            <div class="col span-1-of-4 box">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    ...
                    I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-3.jpg" alt="Customer 3 photo">(Milton Chapman)
</cite>
                    </blockquote>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    ?>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <label for="your-message">Drop us a line</label>
                            </div>
                            <div class="col span-2-of-3">
                                <textarea name="message" placeholder="Your message" id="your-message"></textarea>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col span-1-of-3">
...
<!--    <script src="https://cdn.jsdelivr.nhttps://cdn.jsdelivr.net/g/respond@1.4.2,html5shiv@3.7.3,selectivizr@1.0.3b"></script>-->
